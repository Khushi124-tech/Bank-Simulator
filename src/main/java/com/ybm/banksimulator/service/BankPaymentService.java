...
public class BankPaymentService {
    ...
    public synchronized PaymentRequest receiveTransaction(
        ...
        /*
         * =====================================================
         * BANK CONSOLE LOG - INCOMING REQUEST (DEBUG)
         * =====================================================
         *
         * This is the REAL endpoint the browser actually POSTed
         * to (see BankPaymentController.receiveFromGateway()) -
         * not a placeholder domain. The old fake
         * "https://www.returnurl.com" string here was left over
         * from before /bank/receive existed as a real endpoint;
         * it never matched what was actually happening and has
         * been corrected.
         */
        System.out.println(
                "========================================"
        ...
        System.out.println(
                "[BANK] Received transaction via real browser "
                        + "redirect (GET) to:"
        );
        System.out.println(
                "GET http://localhost:9090/bank/receive"
                        + "?PID=" + pid
                        + "&encdata=" + encdata
        );
